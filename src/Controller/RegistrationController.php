...
class RegistrationController extends AbstractController
{
    ...
    public function register(
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash(
                ...
                [
                    'color' => 'white',
                    'message' => 'Votre compte a été créé avec succès. Veuillez confirmer votre adresse email pour pouvoir vous connecter.',
                ]
            );
    ...
    public function verifyUserEmail(
        ...
        $this->addFlash(
            ...
            [
                'color' => 'white',
                'message' => 'Votre adresse email a été vérifié, vous pouvez maintenant vous connecter.',
            ]
        );
